...
# =====================================================
# ADVANCED DASHBOARD BMI PAGE
# =====================================================
def BMI_page(root, main_menu_callback):
    clear_window(root)
    ...
    def calculate():
        ...
        try:
            ...
            # FIRST, clear the bar canvas
            bar_canvas.delete("all")
            
            # NOW create the colored sections
            ...
            # Create the pointer
            bar_pointer = bar_canvas.create_line(x, 0, x, 25, width=4, fill="black")
            ...
            gauge_canvas.delete("all")
            # Clear the bar canvas on error too
            bar_canvas.delete("all")
            bar_pointer = None
    ...
    tk.Button(card, text="🔙 Back to Main Menu", font=("Segoe UI", 14),
              ...
              command=lambda: main_menu_callback(root)).grid(row=9, column=0, columnspan=2, pady=10)
              command=main_menu)\
